 ...
 */
class Benchmark_Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'ngondro_gar-color-picker-js',
			get_template_directory_uri() . '/inc/customizer/ngondro_gar-color-picker/ngondro_gar-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),
			'1.0.0',
			true
		);
		wp_enqueue_style(
			'ngondro_gar-color-picker-css',
			get_template_directory_uri() . '/inc/customizer/ngondro_gar-color-picker/ngondro_gar-color-picker.css',
